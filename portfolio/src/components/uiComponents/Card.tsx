...
const Card = ({
  ...
  return (
    <div
      className="
      w-full rounded-xl
      bg-light-bg2 dark:bg-dark-bg2
      shadow-[calc(-4px)_4px_8px_var(--color-dark-p),calc(4px)_-4px_4px_var(--color-dark-s)]
      flex flex-col overflow-hidden
      transition-transform duration-500 ease-in-out
      hover:shadow-[0px_0px_10px_2px_var(--color-dark-bg2)]
      hover:z-10
      relative
    "
    >
      ...
      <div className="w-full h-48 sm:h-52 bg-blue-100 overflow-hidden">
        {data.img_src ? (
          <img
            src={data.img_src}
            alt=""
      ...
      <div className="p-3 flex flex-col justify-between flex-1 overflow-hidden">
        ...
        <p
          className="
          text-gray-800 dark:text-dark-p text-sm
          transition-all duration-500 ease-in-out
          line-clamp-4 hover:line-clamp-none
        "
        >
          {data.description}
        </p>
        ...
        >
          <div className="flex">
            <a
              ...
              className="
              text-gray-800 dark:text-dark-a
              font-semibold no-underline hover:underline
              bg-light-s dark:bg-dark-s px-4 py-2 rounded-xl
              text-3xl transition-all duration-500 ease-in-out
            "
            >
              <FaCode />
            </a>
