...
/**
 * Provides the application's root HTML layout and wraps page content with global fonts, theme handling, navigation, and footer.
 *
 * @param children - The page content to render between the NavBar and Footer
 * @returns The root HTML element containing the themed application layout
 */
