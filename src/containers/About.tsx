...
/**
 * Renders a labeled row of themed skill icons for a given category.
 *
 * The component uses the current theme to request matching icons from skillicons.dev and defers rendering until client mount to avoid SSR hydration mismatches.
 *
 * @param label - The visible category label shown to the left of the icons.
 * @param skills - An array of skill identifiers (keys expected by skillicons.dev) to render as icons.
 * @returns A JSX element containing the label and corresponding skill icons, or `null` before client mount.
 */
...
/**
 * Renders the About section containing a short bio and categorized skill lists with themed skill icons.
 *
 * @returns A React element representing the About section, including the bio and grouped skill displays.
 */
