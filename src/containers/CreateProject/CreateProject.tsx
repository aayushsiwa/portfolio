...
/**
 * Renders a two-column form for creating or editing a project with a real-time preview.
 *
 * @param onSubmit - Handler invoked with the project data when the form is submitted.
 * @param onCancel - Optional handler called after the form is reset when cancelling an edit.
 * @param initialData - Optional project used to populate the form for editing.
 * @returns The React element containing the project form and live preview card.
 */
