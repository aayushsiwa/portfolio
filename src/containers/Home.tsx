...
/**
 * Renders the Home page: a responsive hero section with greeting, social links, avatar, and the subsequent page sections.
 *
 * @returns The React element for the Home page containing the hero (including the Scroll control) followed by the About, Projects, and Contact sections.
 */
