...
export default function Footer() {
    return (
        <footer className="bg-lightBg dark:bg-darkBg py-20 w-full h-auto ps-4 flex justify-start items-center gap-4">
            <a
            ...
            >
                <FaLinkedin className="fill-lightA" />
            </a>
            <a
                className="text-4xl text-white hover:scale-125 transition-transform duration-200"
                aria-label="GitHub"
            ...
            >
                <FaGithub className="fill-lightA" />
            </a>
            <a
                className="text-4xl text-white hover:scale-125 transition-transform duration-200"
                aria-label="GitHub"
            ...
            >
                <SiLeetcode className="fill-lightA" />
            </a>
            <a
                className="text-4xl text-white hover:scale-125 transition-transform duration-200"
                aria-label="GitHub"
            ...
            >
                <FaHackerrank className="fill-lightA" />
            </a>
        </footer>
    );
}
