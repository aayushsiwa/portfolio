                ...
                {[
                    {
                        ...
                        description:
                            "A Job Offerings application for Jovian using Flask, with MySQL on Aiven. This app streamlines the job application process, making it easier for job seekers to find and apply for positions, and for companies to manage applications efficiently. By integrating email notifications and hCaptcha for security, it ensures a smooth and secure experience.",
                    ...
                    },
                    {
                        ...
                        description:
                            "A Tutorials application for new learners using Django, with PostgresSQL on Render. This app provides users with basic tutorials to various fields in python programming.",
                        imgSrc: "https://raw.githubusercontent.com/aayushsiwa/python-tutorials/master/screenshot.png",
                        githubLink:
                            "https://github.com/aayushsiwa/python-tutorials",
                    ...
                    <div
                        className="px-2 py-20 w-full flex justify-center gap-2"
                        key={index}
                    >
                        {index % 2 === 0 ? (
                            <>
