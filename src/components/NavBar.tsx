...
/**
 * Renders the site navigation bar with desktop links, a theme toggle, and a mobile slide-out menu.
 *
 * @returns The navigation bar JSX element; returns `null` until the component mounts to avoid SSR hydration mismatch.
 */
